...
const projects = defineCollection({
  ...
  schema: z.object({
    ...
    status: z.string(),
    role: z.string(),
    signature: z.string().min(30),
    platform: z.string(),
    stack: z.array(z.string()).min(2),
    featuredOrder: z.number().int().positive(),
    art: z.string().startsWith('/images/art/'),
    artAlt: z.string().min(20),
    ...
    secondaryWidth: z.number().int().positive(),
    secondaryHeight: z.number().int().positive(),
